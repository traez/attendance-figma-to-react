...
export default function Standard() {
  ...
  const price = selectedPlan === 'yearly' ? 48 : 5;
      ...
      <section className="flex flex-col items-center pb-8 bg-white rounded-2xl border-t-4 border-solid border-blue-600">
        ...
        <article className="flex flex-col self-stretch px-8 w-full text-base">
          ...
          <div className="mt-2 leading-6 text-slate-600">
            Small membership base, you can use this plan. One time $50 startup
            and configuration fee. 5% per transaction
          </div>
            ...
            <menu key={index} className="flex gap-3 px-5 mt-4 w-full">
              ...
              <div
                className={`text-base leading-6 text-slate-600 ${
                  index >= websiteFeatures.length - 5
...
/*
<aside className="justify-center px-4 py-1.5 text-sm font-medium tracking-normal leading-4 text-right text-white whitespace-nowrap bg-blue-600 rounded-t-xl">
        RECOMMENDED
      </aside>
        */